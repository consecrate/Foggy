(() => {
  ...
  function init() {
    ...
    var state = {
      activeTab: "testcase",
      cardData,
      codeStorageKey: cardData.cardId && cardData.serveId ? "foggy:code:" + cardData.cardId + ":" + cardData.serveId : null,
      editorView: null,
  ...
  function setRunningState(running) {
    ...
    checkButton.innerHTML = running ? "Running..." : 'Run <span class="foggy-btn-shortcut">\u2318+\u21B5</span>';
  }
